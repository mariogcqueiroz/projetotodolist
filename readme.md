...
Antes de clonar o repositório, cheque a seguinte configuração git git config --global core.autocrlf false
Depois, clone o repositório, e no diretório desejado, abra o docker, para garantir que o serviço está rodando, abra o CMD e digite docker compose up -d.
Após alguns instantes, a seguinte mensagem deve aparecer no cmd:
 docker compose up -d
[+] Running 5/5
 ✔ Network docker-django-todolist_djangonetwork  Created                                                           0.0s
 ✔ Container redis                               Started                                                           0.1s
 ✔ Container postg                               Started                                                           0.0s
 ✔ Container djngo                               Started                                                           0.0s
 ✔ Container ngnx                                Started                                                           0.0s

Caso os container estejam todos rodando, basta abrir http://localhost:8000/myapp/register/
para se registrar. Ao se registrar, você será direcionado a fazer login, e quando fizer, já pode criar, ver suas tarefas, editar e excluí-las.
